...
pt} \setlength{\headwidth}{6 in} \lhead{\textbf C-DOGS 2008}
\chead{} \rhead{\textbf Friday, March 14, 2008} \lfoot{}
...
%\newcommand{\abSpeaker}[2]{\mbox{\underline{#1}}^{\mbox{#2}}}%
...
\newcommand{\abCoauthorI}[2]{\mbox{, }\mbox{#1}^{\mbox{#2}}\mbox{,}}%
...
\newcommand{\abCoauthorF}[8]{\textrm{\mbox{, }^{#2}\mbox{#1}\mbox{, }^{#4}\mbox{#3}\mbox{, }^{#6}\mbox{#5}\mbox{, }^{#8}\mbox{#7}}}%

\newcommand{\abAffilO}[2]{^{\mbox{#2}}\mbox{\parbox[t]{0.9\linewidth}{\centering #1}}}%
\newcommand{\abAffilT}[4]{^{#2}\mbox{#1}^{#4}\mbox{#3}}%
\newcommand{\abAffilTh}[6]{^{#2}\mbox{#1}\vspace{1 mm}^{#4}\mbox{#3}^{#6}\mbox{#5}}%
\newcommand{\abAffilF}[8]{^{#2}\mbox{#1}^{#4}\mbox{#3}^{#6}\mbox{#5}^{#8}\mbox{#7}}%

\newcommand{\abEmail}[1]{\textsl{Speaker may be reached at }\texttt{#1}}

\newcommand{\sched}[4]{\contentsline{section}{\numberline{} \rm \textsl{#1} \\
#2\hspace{3 mm}(#3)}{#4}}%
...
\thispagestyle{empty}
\begin{figure}
\centerline{\includegraphics[width=7 cm]{cdogs_logo.jpg}}
\end{figure}

\begin{center}\vspace{3 mm}{\Huge\textbf{ C-DOGS 2008}}
...
\vspace{3 mm}{\large Friday March 14, 2008}
...
\sched{}{Coffee}{8:30 \emph{am}}{}
\sched{}{Welcoming Remarks}{9:00 \emph{am}}{}
\sched{Darlene Brownell}{\sl Prochlorococcus marinus \rm as a source of Marine Methyl Iodide (CH$_3$I)}{9:15 \emph{am}}{4}
\sched{Trajce Alcinov}{Long Wavelength Ripples in the Nearshore}{9:30 \emph{am}}{4}
\sched{Jann Paul Mattern}{Application of two Statistical Data Assimilation Procedures to a 1D Biological Model of the BATS Site}{9:45 \emph{am}}{5}
\sched{Yuehua Lin}{Transport variability through the Yucatan Channel: the influence of the Florida Current and flow compensation around Cuba}{10:00 \emph{am}}{5}
\sched{Jennifer Mecking}{The barotropic ocean response to fast moving tropical cyclones affecting Atlantic Canada}{10:15 \emph{am}}{6}
\sched{}{Break}{10:30 \emph{am}}{}
\sched{Lee Titus}{Improving statistical downscaling of general circulation models}{10:45 \emph{am}}{7}
\sched{Angelia S.M. Vanderlaan}{Reducing the risk of lethal encounters: vessels and right whales in the Bay of Fundy and on the Scotian Shelf}{11:00 \emph{am}}{8}
\sched{Xiaomei Ji}{Potential Artificial Beach Design for Baipai Artificial Island, Sanya Bay, Hainan}{11:15 \emph{am}}{9}
\sched{Mark A. Barry}{Bubbling from below: a look at pockmark formation}{11:30 \emph{am}}{10}
\sched{Matthew Corkum}{High Resolution Wind Forecasting along the Coast of Nova Scotia}{11:45 \emph{am}}{11}
\sched{}{Lunch}{12:00 \emph{pm}}{}
\sched{Bo Yang}{Development of a Five-Level Nested-Grid Coastal Circulation Prediction System for the Inner Scotian Shelf}{1:00 \emph{pm}}{12}
\sched{Shana Watanabe}{Patterns in abundance and size of two deep-water gorgonian coral species, in relation to depth and substrate features, along the continental slope at Northeast Channel, Nova Scotia }{1:15 \emph{pm}}{13}
\sched{Simon Higginson}{``De-eddying'' ocean data}{1:30 \emph{pm}}{13}
\sched{Chris L'Esperance}{Non-isovolumetric Measurement of Young's Modulus and Poisson's Ratio of Marine Sediments}{1:45 \emph{pm}}{14}
\sched{Stephanie Moore}{On the Angular Dependence of Acoustic Scattering from Sand in Suspension}{2:00 \emph{pm}}{14}
\sched{}{Break}{14:15 \emph{pm}}{}
\sched{Eric C. J. Oliver}{Extratropical Expressions of the Madden-Julian Oscillation}{2:25 \emph{pm}}{15}
\sched{Kimberley Davies}{Feeding ecology of North Atlantic Right Whales:  the role of zooplankton in controlling the spatiotemporal distribution of a predator across four orders of magnitude in size}{2:40 \emph{pm}}{16}
\sched{Doris Leong}{Sounds like turbulence}{2:55 \emph{pm}}{16}
\sched{Adam J. Comeau}{New method to estimate a parameter of phytoplankton physiology related to primary productivity models}{3:10 \emph{pm}}{16}
\sched{Irene Maier}{Linear Transition Ripples: Crest Alignment and Ripple Migration}{3:25 \emph{pm}}{17}
\sched{}{Break}{15:40 \emph{pm}}{}
\sched{Jennifer E. Kelly}{Isolated Population Dynamics as a  Potential Consequence of Low Abundances for Atlantic Cod}{3:50 \emph{pm}}{18}
\sched{Marie-Noel R. Matthews}{Estimating Geoacoustic Parameters of Gassy Sediment using Low-Frequency Sound in St. Margaret's Bay, Nova Scotia.}{4:05 \emph{pm}}{19}
\sched{Megan Saunders}{Kelp bed defoliation by an introduced bryozoan in St Margarets Bay.}{4:20 \emph{pm}}{19}
\sched{Erin Breen}{Population biology of the invasive European green crab, \sl Carcinus maenas\rm, and two native decapods in a brackish micro-tidal system in Nova Scotia, Canada.}{4:35 \emph{pm}}{20}
\sched{Clark Richards}{Some questions about nonlinear internal wave groups}{4:50 \emph{pm}}{20}
\sched{}{Closing remarks and retire to 5$^{th}$ floor lounge.}{5:05 \emph{pm}}{}
...
%-----------------------------------------------------------------
\begin{minipage}{\linewidth}\begin{center}\begin{minipage}{\linewidth}
  \abTitle{Population biology of the invasive European green crab, \sl Carcinus maenas\rm, and two native decapods in a brackish micro-tidal system in Nova Scotia, Canada.  } \vspace{2 mm} \begin{center}
...
\begin{minipage}{\linewidth}\begin{center}\begin{minipage}{\linewidth}
  ...
  \abSpeaker{Clark~Richards}{1}\abCoauthorO{Dan E. Kelley}{1}  \vspace{2 mm}\begin{center}
