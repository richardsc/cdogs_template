...
\sched{}{Coffee}{8:30}{}
\sched{}{Welcoming Remarks}{9:00}{}
\sched{Chad Gilbert}{Sustainability of scallop populations on Georges Bank: implications of spawning seasonality.}{9:30}{4}
\sched{Diego A. Ibarra}{A 3-D physical-biological model to assess the effect of mussel aquaculture on water-column dynamics in Ship Harbour, Nova Scotia}{9:45}{5}
\sched{Katherine Hastings}{Reconstructing precipitation variations 0-30 kyrs BP in the western equatorial Pacific using organic biomarkers}{10:00}{5}
\sched{Paul Mattern}{Comparing satellite data and model output using image distance measures}{10:15}{6}
\sched{}{Break}{10:30}{}
\sched{Ramon Filgueira}{A box model of carrying-capacity for mussel aquaculture in a Norwegian fjord}{11:00}{6}
\sched{Remi Daigle}{Physiological and Ecological Interactions of Native Cancer spp. and Carcinus Maenas in British Columbia, Canada}{11:15}{7}
\sched{Witold Bagniewski}{Application of variational data assimilation to coupled physical-biological models of the North Atlantic Bloom}{11:30}{8}
\sched{Christopher Algar }{A model for bubble rise in soft sediments}{11:45}{8}
\sched{Trajce Alcinov}{Long Wavelength Ripples in the Nearshore}{12:00}{9}
\sched{Doris Leong}{Does turbulence sound the same from over here, under there, everywhere?}{12:15}{9}
\sched{}{Lunch}{12:30}{}
\sched{Simon Higginson}{Sea level rise: A better understanding from new satellite measurements}{13:30}{10}
\sched{Clark Richards}{Internal wave generation in the St. Lawrence Estuary}{13:45}{10}
\sched{Eric Oliver}{The Madden-Julian Oscillation and Local and Remote Forcing of the Ocean}{14:00}{11}
\sched{Megan Saunders}{Temperature, timing and growth: implications for outbreaks of an introduced species}{14:15}{11}
\sched{Michelle Lloyd}{Influence of density-dependent food consumption, foraging and stacking behaviour on the growth rate of the Northern abalone, Haliotis kamtschatkana}{14:30}{12}
\sched{Angelia S.M. Vanderlaan}{Ships voluntarily alter course to protect endangered whales}{14:45}{13}
\sched{}{Break}{15:00}{}
\sched{Jorge R. Urrego-Blanco}{Development of a nested-grid shelf circulation model using OPA for the eastern Canadian shelf}{15:20}{14}
\sched{Yuehua Lin}{Numerical and observational study of circulation in the Intra-Americas Sea: connection between Gulf of Mexico Loop Current intrusion and throughflow transport variability}{15:35}{15}
\sched{Shiliang Shan}{Numerical Study of Tidal Circulation in Jiaozhou Bay and Adjacent Coastal Waters Using a High-resolution, Three-dimensional Circulation Model}{15:50}{16}
\sched{Sean Brillant}{Groundline profiles on the Bay of Fundy lobster gear as a threat to North Atlantic right whales}{16:05}{17}
\sched{Adam J. Comeau}{Methods: describing phytoplankton physiological variability}{16:20}{18}
\sched{Lisa Delaney}{A Phytoplankton Pigment Extraction Protocol for Marine Sediments}{16:35}{18}
\sched{Kimberley T. A. Davies}{Physical forcing of space-time variation in the copepod prey field of North Atlantic right whales }{16:50}{19}
\sched{}{Closing remarks and retire to 5$^{th}$ floor lounge.}{17:05}{}
...
\begin{minipage}{\linewidth}\begin{center}\begin{minipage}{\linewidth}
  ...
  \abSpeaker{Megan~Saunders}{1}\abCoauthorO{Anna Metaxas}{1}\abCoauthorO{RamÃ³n Filgueira}{1}  \vspace{2 mm}\begin{center}
